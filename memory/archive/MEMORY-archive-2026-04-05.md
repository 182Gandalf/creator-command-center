# Critical Context & Lessons Learned - Updated April 4, 2026

## April 4, 2026 — Midday Summary (11:00 UTC)

### Activity Today
- **10:00 UTC** — Daily improvement suggestion delivered: Splash trend gates pointing to Creator Pro instead of Creator+
  - "Full trend rankings (Creator Pro)" → should be "(Creator+)"
  - "Weekly trend digest email (Creator Pro)" → should be "(Creator+)"
  - **3rd consecutive TOP PICK nomination** — not yet actioned
- No user sessions, no code changes — quiet Saturday morning

### Key Learning
**Three-peat TOP PICK with no action.** The Splash trend misgating has now been the top-nominated fix for 3 consecutive days (Apr 2, 3, 4). Apr 2 — no response. Apr 3 — a different suggestion was presented and declined. Apr 4 — re-nominated. The user is aware of the trend misgating issue but has not acted. This may be intentional deprioritisation or simply a low-engagement weekend. Do not present this same issue a 4th consecutive time — rotate to a fresh finding on Apr 5 to avoid suggestion fatigue.

### Declined Suggestion Tracker (Updated)
- **Apr 2** — Splash trend misgating (TOP PICK) — no response
- **Apr 3** — Hooks copy "5 variations" universal claim — explicitly declined
- **Apr 4** — Splash trend misgating re-nominated — no response yet (quiet Saturday)

### Persistent Bug Tracker (19+ Days — Critical)
1. Pricing page closing section has no CTA button — since Mar 16 ← **19 days**
2. Studio plan reads "Everything in Creator, plus:" — should be "Creator Pro" — since Mar 16 ← **19 days**
3. Studio Personalization reads "Everything in Creator" — should be "Creator Pro" — since Mar 31 ← **4 days**
4. Studio Trend row anchors against Creator instead of Creator Pro — since Mar 31 ← **4 days**
5. Homepage features block: "30-day calendar" as universal claim — since Mar 30 ← **5 days**
6. Homepage: "Ten questions at signup" — Splash gets 5 — since Mar 26 ← **9 days**
7. Creator plan lists Zapier as "(Creator Pro+)" inline — since Mar 23 ← **12 days**
8. Splash trend features gated at Creator Pro instead of Creator+ — since Apr 2 ← **3 days** (TOP PICK 3× — rotate tomorrow)
9. Homepage hooks block: "5 variations" claimed universally — Splash gets 3 — since Mar 24 ← **11 days** (declined Apr 3)

### New Issues from Apr 4 Analysis
- Hero CTA trust strip reduced from 3 lines to 2 — product benefit (calendar line) removed, conversion regression
- Studio "Workspaces" labelled "Early Access" — undermines Studio's headline differentiator for paying users
- Creator Pro and Studio have identical trend intelligence — no Studio-exclusive trend feature
- Dashboard extractable content now minimal (1.2KB) — public demo value has contracted
- Dashboard still hardcodes "Platform: TikTok" — contradicts cross-platform homepage positioning

---

# Critical Context & Lessons Learned - Updated April 3, 2026

## April 3, 2026 — Midday Summary (15:00 UTC)

### Activity Today
- **10:00 UTC** — Daily improvement suggestion delivered: Homepage hooks feature block claims "5 variations with every idea" — Splash users only get 3
- **~10:xx UTC** — Crypto Raven **explicitly declined** the suggestion
- **15:00 UTC** — Midday review completed
- No code changes, no commits — all activity automated

### Key Learning
**User declined the suggestion explicitly ("i decline the suggestion").** This is new behaviour — previously suggestions were either actioned or silently ignored. Declining is useful signal: it means the user is aware of the issue but has chosen not to prioritise it. Declined suggestions should be tracked to avoid re-presenting them in future cycles.

### Pattern Observation
Two consecutive TOP PICK suggestions now declined or unactioned: Apr 2 (Splash misgating — no response) and Apr 3 (hooks copy — explicitly declined). This may indicate a lower-engagement period or competing priorities. Fridays have historically seen more activity; the expected uptick has not materialised today.

### Persistent Bug Tracker (18+ Days — Critical)
1. Pricing page closing section has no CTA button — since Mar 16 ← **18 days**
2. Studio plan reads "Everything in Creator, plus:" — should be "Creator Pro" — since Mar 16 ← **18 days**
3. Studio Personalization reads "Everything in Creator" — should be "Creator Pro" — since Mar 31 ← **3 days**
4. Studio Trend row anchors against Creator instead of Creator Pro — since Mar 31 ← **3 days**
5. Homepage features block: "30-day calendar" as universal claim — since Mar 30 ← **4 days**
6. Homepage: "Ten questions at signup" — Splash gets 5 — since Mar 26 ← **8 days**
7. Creator plan lists Zapier as "(Creator Pro+)" inline — since Mar 23 ← **11 days**
8. Splash trend features gated at Creator Pro instead of Creator+ — since Apr 2 ← **2 days** (TOP PICK Apr 2, not actioned)
9. Homepage hooks block: "5 variations" claimed universally — Splash gets 3 — since Mar 24 ← **10 days** (TOP PICK Apr 3, **declined**)

### Declined Suggestion Tracker
- **Apr 2** — Splash trend misgating (TOP PICK) — no response / silent non-action
- **Apr 3** — Hooks copy "5 variations" universal claim — explicitly declined ("i decline the suggestion")

---

# Critical Context & Lessons Learned - Updated April 2, 2026

## April 2, 2026 — End of Day Summary (19:00 UTC)

### Activity Today
- **10:00 UTC** — Daily improvement suggestion delivered: Splash plan misgates trend features at Creator Pro tier instead of Creator
  - "Full trend rankings (Creator Pro)" and "Weekly trend digest email (Creator Pro)" both incorrect — these unlock at Creator ($12/mo)
  - Fix: change `(Creator Pro)` → `(Creator+)` on both lines — trivial effort, high revenue impact
- **11:00, 15:00, 19:00 UTC** — Memory reviews completed
- No direct user sessions all day — quiet Thursday, fully automated
- No commits, no code changes, no user responses received

### ✅ Progress Noted (From April 2 Analysis)
- Dashboard double "Loading trends…" partially resolved — Ideas section now shows contextual "Analyzing trends…" text; Trends section still has one unresolved loading state for unauthenticated users

### Persistent Bug Tracker (17+ Days — Critical)
...
3. Studio Personalization reads "Everything in Creator" — should be "Creator Pro" — since Mar 31 ← **2 days**
4. Studio Trend row anchors against Creator instead of Creator Pro — since Mar 31 ← **2 days**
5. Homepage features block: "30-day calendar" as universal claim — since Mar 30 ← **3 days**
...
### Key Learning
**Misgating at the wrong tier is a silent conversion killer.** When a gate points users to a more expensive plan than needed, it doesn't just fail to convert — it actively redirects budget-sensitive users away from the correct (cheaper, easier) upgrade path. Two-character fixes can have outsized revenue impact.

### Pattern Observation
Thursday continues to be a fully silent day — no user engagement, all cron-driven. This is the second consecutive quiet Thursday (matching Mar 26 pattern). Fridays have historically seen more user activity; the Apr 2 improvement suggestion may be actioned tomorrow.
